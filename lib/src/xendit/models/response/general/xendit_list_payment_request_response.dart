...
//
//     final xenditListPaymentRequestResponse = xenditListPaymentRequestResponseFromJson(jsonString);
...
XenditListPaymentRequestResponse xenditListPaymentRequestResponseFromJson(
        String str) =>
    XenditListPaymentRequestResponse.fromJson(json.decode(str));

String xenditListPaymentRequestResponseToJson(
        XenditListPaymentRequestResponse data) =>
